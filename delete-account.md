...
## Request full account deletion in the app

1. Open **Account** in SceneNest.
2. Tap **Request full account deletion**.
3. Read and accept both confirmations.

This immediately and permanently deletes the SceneNest cloud data described below, then records a
request to delete the Entra External ID sign-in identity. A SceneNest administrator separately
verifies and approves the identity deletion before performing it. The SceneNest mobile service does
...
- **Family Sharing membership** — if you are an Editor, your membership is removed. If you own a
  group with other members, ownership transfers to a remaining member and its shared lists stay
  available. If you are the only member, the group and its shared lists are deleted.

## What is kept, and for how long

- **Your Entra External ID sign-in identity** — the identity provider account, including your email
  address and the display name you chose at sign-up, remains after cloud-data deletion. It is removed
  only after a full-account-deletion request is separately verified and approved. You can make that
  request in the app, or email **[scenenest.privacy@outlook.com](mailto:scenenest.privacy@outlook.com)**
  from the address you use to sign in with **Delete my full SceneNest account** in the subject line.
  We will confirm completion by email within 30 days.
